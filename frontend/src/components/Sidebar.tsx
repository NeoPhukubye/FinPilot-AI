...
const navItems = [
  ...
  { id: 'transactions', label: 'Money In/Out', icon: 'M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4' },
  { id: 'growth', label: 'Grow Money', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
